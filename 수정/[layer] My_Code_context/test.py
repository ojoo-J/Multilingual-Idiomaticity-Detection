...
def create_submission():
    ...
    final_pred = pd.read_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[layer] My_Code_context/submission/final.csv')
    submission= pd.read_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[layer] My_Code_context/submission/eval_submission_format.csv')
    ...
    submission.to_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[layer] My_Code_context/submission/task2_subtaska.csv', index=False, encoding='cp949')
...
def combine_zero_one():
    ...
    zero = pd.read_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[layer] My_Code_context/zero.csv')
    one = pd.read_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[layer] My_Code_context/one.csv')
    one['Setting']='one_shot'
    len(zero)
    len(one)
    submission = pd.concat([zero, one], axis=0)
    len(submission)
    submission.to_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[layer] My_Code_context/task2_subtaska.csv', index=False, encoding='cp949')