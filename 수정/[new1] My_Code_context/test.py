...
a = ['▁De', '▁acordo', '▁com', '▁presidente', '▁do', '▁bloc', 'o', ',', '▁Paulo', '▁de', '▁Tá', 'rsi', 'o', ',', '▁o', '▁Ga', 'to', '▁Ping', 'ado', '▁é', '▁um', '▁dos', '▁mais', '▁tradicionais', '▁de', '▁Go', 'i', 'ân', 'ia', '▁e', '▁está', '▁há', '▁11', '▁anos', '▁levando', '▁alegria', '▁ao', '▁moradores', '▁da', '▁região', '.']
print(len(a))
b = ['▁De', '▁acordo', '▁com', '▁presidente', '▁do', '▁bloc', 'o', ',', '▁Paulo', '▁de', '▁Tá', 'rsi', 'o', ',', '▁o', '▁é', '▁um', '▁dos', '▁mais', '▁tradicionais', '▁de', '▁Go', 'i', 'ân', 'ia', '▁e', '▁está', '▁há', '▁11', '▁anos', '▁levando', '▁alegria', '▁ao', '▁moradores', '▁da', '▁região', '.']
print(len(b))
...
def combine_zero_one():
    ...
    zero = pd.read_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[new1] My_Code_context/zero.csv')
    one = pd.read_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[new1] My_Code_context/one.csv')
    one['Setting'] = 'one_shot'
    len(zero)
    len(one)
    submission = pd.concat([zero, one], axis=0)
    len(submission)
    submission.to_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[new1] My_Code_context/task2_subtaska.csv', index=False, encoding='cp949')


train = pd.read_csv('/home/ojoo/SemEval-2022-Task2/MelBERT/[new1] My_Code_context/data/preproc/train.csv', sep='\t')
